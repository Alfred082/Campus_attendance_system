...
public class RecordController {
    ...
    public Object doRecord(
         ...
         * 先默认始终为真
         */
        String path2 = "F:/NIITProject/project-interface/src/main/resources/static/check/" + studentId + "_" + attendId + ".png";
        String path1 = "F:/NIITProject/project-interface/src/main/resources/static/face/" + studentId + ".png";
